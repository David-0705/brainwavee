  ...
  return (
    ...
    >
      <div className="container relative" >
        <div className="relative z-1 max-w-[80rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]" ref={parallaxRef}>
           {/* Hero Title */}
          ...
          Experience creativity and inspiration like never before with dazzling light-driven adventures
          </p>
