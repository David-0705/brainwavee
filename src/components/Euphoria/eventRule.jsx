...
export default function eventRule({ data }) {
    ...
    const matchData = data.sportCheck && Data[data.sportCheck] ? Data[data.sportCheck].slice(0, 4) : null;
                        ...
                        <div className="flex flex-col items-center gap-2 m-4">
                            ...
                            {matchData.map((match, index) => (
                                <div key={index} className="match-container relative">
                                    ...
                                    <img src="https://city-png.b-cdn.net/preview/preview_public/uploads/preview/hd-india-national-cricket-team-logo-transparent-png-701751712500401nel3jkkg04.png" alt="South-Africa flag" className="flag" />
                                </div>
                            ))}
                        </div>
                    )}
